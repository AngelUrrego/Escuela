                        ...
                        <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                            <div class="p-30 invisible" data-toggle="appear">
                                ...
                                <p class="font-italic text-white-op">
                                     &copy; <span class="js-year-copy">2022</span>
                                </p>
                            </div>
                        </div>
                        <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                            <div class="content content-full">
                                ...
                                <a class="link-effect font-w700" href="index.html">
                                        ...
                                        <span class="font-size-xl text-primary-dark">INTERNACIONAL </span><span class="font-size-xl">S.A</span>
                                    </a>
                                ...
                                <div class="bg-image" style="background-image: url('public/assets/img/photos/photo34@3x.png');">
